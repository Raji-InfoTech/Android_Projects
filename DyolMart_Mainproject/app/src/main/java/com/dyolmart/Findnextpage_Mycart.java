...
public class Findnextpage_Mycart extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference_accessories= FirebaseDatabase.getInstance().getReference().child("Customer_Details/Mycart");
            ...
            public void onClick(View v) {
                ...
                databaseReference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        Toast.makeText(com.dyolmart.Findnextpage_Mycart.this, "Add to Cart Successfully", Toast.LENGTH_SHORT).show();
                    }
            ...
            public void onClick(View v) {
                ...
                databaseReference_wishlist.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        Toast.makeText(Findnextpage_Mycart.this, "Add to Wishlist", Toast.LENGTH_LONG).show();
                    }
    ...
    private void addTabs(ViewPager viewPager) {
        com.dyolmart.Findnextpage_Mycart.ViewPagerAdapter adapter = new com.dyolmart.Findnextpage_Mycart.ViewPagerAdapter(getSupportFragmentManager());
