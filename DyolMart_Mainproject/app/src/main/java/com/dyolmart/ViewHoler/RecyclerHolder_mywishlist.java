...
public class RecyclerHolder_mywishlist extends FirebaseRecyclerAdapter<products, RecyclerHolder.myview> {

    public RecyclerHolder_mywishlist(@NonNull FirebaseRecyclerOptions<products> options) {
        super(options);
    }
    ...
    protected void onBindViewHolder(@NonNull RecyclerHolder.myview holder, int position, @NonNull products model) {
        ...
        holder.view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(v.getContext(), com.dyolmart.Findnextpage_MyWishlist.class);
    ...
    public class myview extends RecyclerView.ViewHolder {
        ...
        public myview(@NonNull View itemView) {
            ...
            //t3 = (TextView) itemView.findViewById(R.id.myorder_name);
