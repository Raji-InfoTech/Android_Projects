...
public class ViewHolder_Watches extends RecyclerView.Adapter<ViewHolder_Watches.myview>  {

    ArrayList<products> list;


    public ViewHolder_Watches(ArrayList<products> list) {
        this.list = list;
    }
    ...
    public void onBindViewHolder(@NonNull myview holder, int position) {
        ...
        holder.view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(v.getContext(), com.dyolmart.FindnextPage.Findnextpage_Watches.class);
