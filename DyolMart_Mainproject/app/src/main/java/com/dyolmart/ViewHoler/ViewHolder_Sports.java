...
public class ViewHolder_Sports extends RecyclerView.Adapter<ViewHolder_Sports.myview> {

    ArrayList<products> list;


    public ViewHolder_Sports(ArrayList<products> list) {
        this.list = list;
    }
    @NonNull
    @Override
    ...
    public void onBindViewHolder(@NonNull myview holder, int position) {
        ...
        holder.view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(v.getContext(), com.dyolmart.FindnextPage.Findnextpage_Sports.class);
