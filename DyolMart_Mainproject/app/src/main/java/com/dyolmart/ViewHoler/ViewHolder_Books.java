...
public class ViewHolder_Books extends RecyclerView.Adapter<ViewHolder_Books.myview> {
    ArrayList<products> list;

    public ViewHolder_Books(ArrayList<products> list) {
        this.list = list;
    }
    ...
    public void onBindViewHolder(@NonNull myview holder, int position) {
        ...
        holder.view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(v.getContext(), com.dyolmart.FindnextPage.Findnextpage_Book.class);
