...
public class ViewHolder_Accessories extends RecyclerView.Adapter<ViewHolder_Accessories.myview> {
    ArrayList<products> list;

    public ViewHolder_Accessories(ArrayList<products> list) {
        this.list = list;
    }
    ...
    public void onBindViewHolder(@NonNull myview holder, int position) {
        ...
        holder.view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(v.getContext(),com.dyolmart.FindnextPage.Findnextpage_Accessories.class);
