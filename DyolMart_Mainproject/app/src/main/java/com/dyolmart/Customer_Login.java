...
public class Customer_Login extends AppCompatActivity {
            ...
            public void onClick(View v) {
                ...
                if (!country_code.isEmpty() || !phone.isEmpty()){
                    PhoneAuthOptions options = PhoneAuthOptions.newBuilder(auth)
                            ...
                            .setActivity(com.dyolmart.Customer_Login.this)
        ...
        mCallBacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onCodeSent(@NonNull String s, @NonNull PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent otpIntent = new Intent(com.dyolmart.Customer_Login.this ,com.dyolmart.OTP_verifyform.class);
    ...
    private void sendToMain(){
        Intent mainIntent = new Intent(com.dyolmart.Customer_Login.this ,com.dyolmart.HomeScreen.class);
