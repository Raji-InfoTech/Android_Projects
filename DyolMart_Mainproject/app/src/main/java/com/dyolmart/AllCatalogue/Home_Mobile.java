...
import com.dyolmart.ViewHoler.ViewHolder_Mobile;


public class Home_Mobile extends AppCompatActivity {
    private DatabaseReference productsref;
    private RecyclerView recyclerView;
    RecyclerView.LayoutManager layoutManager;
    ViewHolder_Mobile viewHolder;
    ImageView imageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(R.string.Mobiles);
        ...
        query=productsref.orderByChild ("Category").equalTo ("Mobiles");
        recyclerView = findViewById( R.id.recyclerview_mobile);
        searchView =  findViewById( R.id.Searchbar_mobile);
            ...
            query.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    if(snapshot.exists()){
                        ...
                        viewHolder = new ViewHolder_Mobile(list);
    ...
    private void search(String str){
        ...
        viewHolder = new ViewHolder_Mobile(mlist);
        recyclerView.setAdapter(viewHolder);
    }
    @Override
