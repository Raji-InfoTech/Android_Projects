...
import com.dyolmart.ViewHoler.ViewHolder_Fashion;

public class Home_Fashion extends AppCompatActivity {
    private DatabaseReference productsref;
    private RecyclerView recyclerView;
    RecyclerView.LayoutManager layoutManager;
    ViewHolder_Fashion viewHolder;
    ImageView imageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.home_fashion );
        ...
        query=productsref.orderByChild ("Category").equalTo ("Fashion");
        recyclerView = findViewById( R.id.recyclerview_fashion );
        searchView = findViewById( R.id.Searchbar_fashion );
            ...
            query.addValueEventListener( new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    if (snapshot.exists()) {
                        ...
                        viewHolder = new ViewHolder_Fashion( list );
    ...
    private void search(String str) {
        ...
        viewHolder = new ViewHolder_Fashion( mlist );
        recyclerView.setAdapter( viewHolder );
    }
    @Override
