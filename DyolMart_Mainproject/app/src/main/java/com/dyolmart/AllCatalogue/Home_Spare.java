...
import com.dyolmart.ViewHoler.ViewHolder_Spares;

public class Home_Spare extends AppCompatActivity {
    private DatabaseReference productsref;
    private RecyclerView recyclerView;
    RecyclerView.LayoutManager layoutManager;
    ViewHolder_Spares viewHolder;
    ImageView imageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.home__spare);
        ...
        query=productsref.orderByChild ("Category").equalTo ("Spare");
        recyclerView = findViewById( R.id.recyclerview_spare);
        searchView =  findViewById( R.id.Searchbar_spare);
            ...
            query.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    if(snapshot.exists()){
                        ...
                        viewHolder = new ViewHolder_Spares(list);
    ...
    private void search(String str){
        ...
        viewHolder = new ViewHolder_Spares(mlist);
        recyclerView.setAdapter(viewHolder);
    }
    @Override
