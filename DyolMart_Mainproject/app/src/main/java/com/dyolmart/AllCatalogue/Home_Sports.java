...
import com.dyolmart.ViewHoler.ViewHolder_Sports;

public class Home_Sports extends AppCompatActivity {
    private DatabaseReference productsref;
    private RecyclerView recyclerView;
    RecyclerView.LayoutManager layoutManager;
    ViewHolder_Sports viewHolder;
    ImageView imageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.home_sports);
        ...
        query=productsref.orderByChild ("Category").equalTo ("Sports");
        recyclerView = findViewById( R.id.recyclerview_sports);
        searchView =  findViewById( R.id.Searchbar_sports);
            ...
            query.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    if(snapshot.exists()){
                        ...
                        viewHolder = new ViewHolder_Sports(list);
    ...
    private void search(String str){
        ...
        viewHolder = new ViewHolder_Sports(mlist);
        recyclerView.setAdapter(viewHolder);
    }
    @Override
