...
import com.dyolmart.ViewHoler.ViewHolder_Lappc;

public class Home_Lappc extends AppCompatActivity {
    private DatabaseReference productsref;
    private RecyclerView recyclerView;
    RecyclerView.LayoutManager layoutManager;
    ViewHolder_Lappc viewHolder;
    ImageView imageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.home_lappc);
        getSupportActionBar().setTitle(R.string.Lap);
        ...
        query=productsref.orderByChild ("Category").equalTo ("Laptop & Computer");
        recyclerView = findViewById( R.id.recyclerview_lappc);
        searchView =  findViewById( R.id.Searchbar_lappc);
            ...
            query.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    if(snapshot.exists()){
                        ...
                        viewHolder = new ViewHolder_Lappc(list);
    ...
    private void search(String str){
        ...
        viewHolder = new ViewHolder_Lappc(mlist);
        recyclerView.setAdapter(viewHolder);
    }
    @Override
