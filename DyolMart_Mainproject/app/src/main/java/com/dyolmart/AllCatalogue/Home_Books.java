...
import com.dyolmart.ViewHoler.ViewHolder_Books;

public class Home_Books extends AppCompatActivity {
    private DatabaseReference productsref;
    private RecyclerView recyclerView;
    RecyclerView.LayoutManager layoutManager;
    ViewHolder_Books viewHolder;
    ImageView imageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.home__books);
        ...
        query=productsref.orderByChild ("Category").equalTo ("Book");
        recyclerView = findViewById( R.id.recyclerview_books);
        searchView =  findViewById( R.id.Searchbar_book);
        ...
        if(query != null){
            query.addValueEventListener(new ValueEventListener() {
                ...
                if(snapshot.exists()){
                    ...
                    viewHolder = new ViewHolder_Books(list);
    ...
    private void search(String str){
        ...
        viewHolder = new ViewHolder_Books(mlist);
        recyclerView.setAdapter(viewHolder);
    }
    @Override
