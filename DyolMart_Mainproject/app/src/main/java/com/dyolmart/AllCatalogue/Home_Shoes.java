...
import com.dyolmart.ViewHoler.ViewHolder_Shoes;

public class Home_Shoes extends AppCompatActivity {
    private DatabaseReference productsref;
    private RecyclerView recyclerView;
    RecyclerView.LayoutManager layoutManager;
    ViewHolder_Shoes viewHolder;
    ImageView imageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.home_shoes);
        getSupportActionBar().setTitle(R.string.Shoes);
        ...
        query=productsref.orderByChild ("Category").equalTo ("Footwear");
        recyclerView = findViewById( R.id.recyclerview_shoes);
        searchView =  findViewById( R.id.Searchbar_shoes);
            ...
            query.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    if(snapshot.exists()){
                        ...
                        viewHolder = new ViewHolder_Shoes(list);
    ...
    private void search(String str){
        ...
        viewHolder = new ViewHolder_Shoes(mlist);
        recyclerView.setAdapter(viewHolder);
    }
    @Override
