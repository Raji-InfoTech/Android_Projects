...
import com.dyolmart.ViewHoler.ViewHolder_Accessories;
...
public class Home_Accessories extends AppCompatActivity {
    private DatabaseReference productsref;
    private RecyclerView recyclerView;
    RecyclerView.LayoutManager layoutManager;
    ViewHolder_Accessories viewHolder;
    ImageView imageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.home__accessories);
        ...
        query=productsref.orderByChild ("Category").equalTo ("Accessories");
        recyclerView = findViewById( R.id.recyclerview_accessories);
        searchView =  findViewById( R.id.Searchbar_accessories);
            ...
            query.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    if(snapshot.exists()){
                        ...
                        viewHolder = new ViewHolder_Accessories(list);
    ...
    private void search(String str){
        ...
        viewHolder = new ViewHolder_Accessories(mlist);
        recyclerView.setAdapter(viewHolder);
    }
    @Override
