...
import com.dyolmart.FindnextPage.Findnextpage_Accessories;
...
public class Homebannerad_Shop extends AppCompatActivity {
    ViewPager itemImage;
    TextView itemName,itemPrice,shopnumber,buynow,S1,S2,S3,S4,S5,S6,addcart,customernum;
    DatabaseReference databaseReference_shop1,databaseReference_shop2,databaseReference,databaseReference_accessories1,databaseReference_wishlist;
    ...
    String branddesc1,brandfeature,brandOneprice,BrandTwoprice,BrandThreeprice,BrandFourprice,BrandFiveprice,BrandSixprice,Imageurl,value,
            Imageurl1,Imageurl2,Imageurl3,s1,s2,s3,s4,s5,s6,shopid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference_accessories1= FirebaseDatabase.getInstance().getReference().child("All_Products");
        databaseReference_shop1= FirebaseDatabase.getInstance().getReference().child("Home_product/Table_1");
        databaseReference_shop2= FirebaseDatabase.getInstance().getReference().child("Home_product/Table_2");
        ...
        databaseReference_shop1.orderByChild( "Brand_Name" ).equalTo( name ).addValueEventListener( new ValueEventListener () {
                ...
                for (DataSnapshot dataSnapshot: snapshot.getChildren()){
                    ...
                    S1.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            databaseReference_shop1.addValueEventListener(new ValueEventListener() {
                                @SuppressLint("ResourceAsColor")
                                @Override
                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                    itemPrice.setText(brandOneprice);
                                    S1.setTextColor(R.color.purple_500);
        ...
        databaseReference_shop2.orderByChild( "Brand_Name" ).equalTo( name ).addValueEventListener( new ValueEventListener () {
            @SuppressLint("ResourceAsColor")
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot dataSnapshot: snapshot.getChildren()){
                    ...
                    S1.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            databaseReference_shop2.addValueEventListener(new ValueEventListener() {
                                @SuppressLint("ResourceAsColor")
                                @Override
                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                    itemPrice.setText(brandOneprice);
        ...
        databaseReference_accessories1.orderByChild( "Brand_Name" ).equalTo( name ).addValueEventListener( new ValueEventListener () {
            @SuppressLint("ResourceAsColor")
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot dataSnapshot: snapshot.getChildren()){
                    ...
                    S1.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            databaseReference_accessories1.addValueEventListener(new ValueEventListener() {
                                @SuppressLint("ResourceAsColor")
                                @Override
                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                    itemPrice.setText(brandOneprice);
            ...
            public void onClick(View v) {
                ...
                databaseReference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        Toast.makeText(com.dyolmart.Homebannerad_Shop.this, "Add to Cart Successfully", Toast.LENGTH_SHORT).show();
                    }
            ...
            public void onClick(View v) {
                ...
                databaseReference_wishlist.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        Toast.makeText(Homebannerad_Shop.this, "Add to Wishlist", Toast.LENGTH_SHORT).show();
                    }
    ...
    private void addTabs(ViewPager viewPager) {
        com.dyolmart.Homebannerad_Shop.ViewPagerAdapter adapter = new com.dyolmart.Homebannerad_Shop.ViewPagerAdapter (getSupportFragmentManager());
