...
public class Findnextpage_Book extends AppCompatActivity {
    ViewPager itemImage;
    ...
    String branddesc1,brandfeature,Imageurl,Imageurl1,Imageurl2,Imageurl3,value,shopid,item_size="null";
            ...
            public void onClick(View v) {
                ...
                databaseReference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        Toast.makeText(Findnextpage_Book.this, "Add to Cart Successfully", Toast.LENGTH_SHORT).show();
                    }
            ...
            public void onClick(View v) {
                ...
                databaseReference_wishlist.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        Toast.makeText(Findnextpage_Book.this, "Add to Wishlist", Toast.LENGTH_SHORT).show();
                    }
