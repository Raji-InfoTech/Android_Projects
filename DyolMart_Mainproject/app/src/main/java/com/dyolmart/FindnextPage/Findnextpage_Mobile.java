...
Findnextpage_Mobile extends AppCompatActivity {
            ...
            public void onClick(View v) {
                ...
                databaseReference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        Toast.makeText(Findnextpage_Mobile.this, "Add to Cart Successfully", Toast.LENGTH_SHORT).show();
                    }
            ...
            public void onClick(View v) {
                ...
                databaseReference_wishlist.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        Toast.makeText(Findnextpage_Mobile.this, "Add to Wishlist", Toast.LENGTH_SHORT).show();
                    }
