...
public class Findnextpage_Sports extends AppCompatActivity {
    ViewPager itemImage;
    ...
    String branddesc1,brandfeature,brandOneprice,Imageurl,Imageurl1,Imageurl2,Imageurl3,shopid,value,item_size="null";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(R.string.Sports);
            ...
            public void onClick(View v) {
                ...
                databaseReference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        Toast.makeText(Findnextpage_Sports.this, "Add to Cart Successfully", Toast.LENGTH_SHORT).show();
                    }
            ...
            public void onClick(View v) {
                ...
                databaseReference_wishlist.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        Toast.makeText(Findnextpage_Sports.this, "Add to Wishlist", Toast.LENGTH_SHORT).show();
                    }
