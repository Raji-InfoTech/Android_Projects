...
public class Findnextpage_Lappc extends AppCompatActivity {
        ...
        databaseReference_accessories.orderByChild( "Brand_Name" ).equalTo( name ).addValueEventListener( new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot dataSnapshot: snapshot.getChildren()){
                    ...
                    s5 = prdct.getSize_5();
                    s6 = prdct.getSize_6();
                    System.out.println("asdfghjk"+s6);
            ...
            public void onClick(View v) {
                ...
                databaseReference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        Toast.makeText(Findnextpage_Lappc.this, "Add to Cart Successfully", Toast.LENGTH_SHORT).show();
                    }
            ...
            public void onClick(View v) {
                ...
                databaseReference_wishlist.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        Toast.makeText(Findnextpage_Lappc.this, "Add to Wishlist", Toast.LENGTH_SHORT).show();
                    }
