 ...
 public class Findnextpage_Beauty extends AppCompatActivity {
     ViewPager itemImage;
         ...
         databaseReference_accessories.orderByChild( "Brand_Name" ).equalTo( name ).addValueEventListener( new ValueEventListener() {
             ...
             public void onDataChange(@NonNull DataSnapshot snapshot) {
                 for (DataSnapshot dataSnapshot: snapshot.getChildren()){
                     ...
                     imageAdapter=new ImageAdapter(getApplicationContext(),image);
             ...
             public void onClick(View v) {
                 ...
                 databaseReference.addValueEventListener(new ValueEventListener() {
                     ...
                     public void onDataChange(@NonNull DataSnapshot snapshot) {
                         ...
                         Toast.makeText(Findnextpage_Beauty.this, "Add to Cart Successfully", Toast.LENGTH_SHORT).show();
                     }
             ...
             public void onClick(View v) {
                 ...
                 databaseReference_wishlist.addValueEventListener(new ValueEventListener() {
                     ...
                     public void onDataChange(@NonNull DataSnapshot snapshot) {
                         ...
                         Toast.makeText(Findnextpage_Beauty.this, "Add to Wishlist", Toast.LENGTH_SHORT).show();
                     }
