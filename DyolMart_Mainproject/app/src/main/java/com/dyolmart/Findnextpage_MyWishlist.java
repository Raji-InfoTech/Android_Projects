...
public class Findnextpage_MyWishlist  extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference_accessories= FirebaseDatabase.getInstance().getReference().child("Customer_Details/Mywishlist");
        databaseReference= FirebaseDatabase.getInstance().getReference().child("Customer_Details/Mywishlist");
            ...
            public void onClick(View v) {
                ...
                databaseReference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        Toast.makeText(com.dyolmart.Findnextpage_MyWishlist.this, "Add to Cart Successfully", Toast.LENGTH_SHORT).show();
                    }
            ...
            public void onClick(View v) {
                ...
                databaseReference_wishlist.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        Toast.makeText(Findnextpage_MyWishlist.this, "Add to Wishlist", Toast.LENGTH_SHORT).show();
                    }
    ...
    private void addTabs(ViewPager viewPager) {
        com.dyolmart.Findnextpage_MyWishlist.ViewPagerAdapter adapter = new com.dyolmart.Findnextpage_MyWishlist.ViewPagerAdapter(getSupportFragmentManager());
